...
const List<ReduceCarbonTipp> constantsTipps = [
  ...
  ReduceCarbonTipp(
    ...
    "According to McKinsey, using recycled content in plastic packaging can reduce greenhouse gas emissions by up to 50%",
    "https://www.mckinsey.com/industries/paper-forest-products-and-packaging/our-insights/true-packaging-sustainability-understanding-the-performance-trade-offs"
  ),

   ReduceCarbonTipp(
    "Embrace plant-based alternatives to meat",
    "Opting for plant-based meat alternatives can lower your environmental impact and support a healthier lifestyle. By choosing these options, you're not only reducing greenhouse gas emissions, but also benefiting from a diverse and nutrient-rich diet.",
    1.5,
    "assets/images/sausage.png",
    "1 kg of pork produces around 4.6 kg of CO2e emissions, whilst 1 kg of lentils produces only around 1.2 kg of CO2e emissions",
  ...
  ReduceCarbonTipp(
    ...
    "1 kg of chicken produces around 5.5 kg of CO2e emissions, whilst 1 kg of plant based nuggets produces only around 1.3 kg of CO2e emissions",
    "https://www.ifeu.de/fileadmin/uploads/Reinhardt-Gaertner-Wagner-2020-Oekologische-Fu%C3%9Fabdruecke-von-Lebensmitteln-und-Gerichten-in-Deutschland-ifeu-2020.pdf"
  ),
  ...
  ReduceCarbonTipp(
    ...
    "1 kg of milk produces around 1.4 kg of CO2e emissions, whilst 1 kg of oat milk produces only around 0.3 kg of CO2e emissions",
    "https://www.ifeu.de/fileadmin/uploads/Reinhardt-Gaertner-Wagner-2020-Oekologische-Fu%C3%9Fabdruecke-von-Lebensmitteln-und-Gerichten-in-Deutschland-ifeu-2020.pdf"
  ),
